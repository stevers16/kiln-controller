...
#   Fan pin 3 (tach/green) → GP22 via 10kΩ pull-up to 3.3V + 104 cap to GND
#   Fan pin 4 (PWM/blue)   → GP16 via 100Ω series resistor
#   MOSFET gate (GP21)     → 100Ω gate resistor → GP21; 10kΩ pull-down to GND
